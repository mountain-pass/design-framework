  ...
  return (
    <SheetPrimitive.Portal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn("fixed inset-y-0 right-0 z-50 flex h-full w-full max-w-md flex-col border-l", "border-2 border-border bg-popover text-popover-foreground shadow-lg", className)}
        {...props}
      >
        {children}
      </SheetPrimitive.Content>
...
const sheetCloseClass = "-mr-2 -mt-2 inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
