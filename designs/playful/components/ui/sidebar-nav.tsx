...
function SidebarNavItem({
  ...
  return (
    <a
      ...
      className={cn(active ? "flex h-9 items-center gap-2.5 rounded-lg bg-sidebar-accent px-2 text-sm font-medium text-sidebar-accent-foreground" : "flex h-9 items-center gap-2.5 rounded-lg px-2 text-sm text-muted-foreground transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground", className)}
      {...props}
    />
  )
}
