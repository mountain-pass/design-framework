  ...
  return (
    <AlertDialogPrimitive.Portal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn("fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2", "rounded-none border border-border bg-popover p-6 text-popover-foreground shadow-lg", className)}
        {...props}
      />
    </AlertDialogPrimitive.Portal>
  )
